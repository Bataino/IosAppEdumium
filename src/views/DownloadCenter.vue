    ...
    <ion-content>
      <ion-tabs class="">
        ...
        <ion-tab-bar slot="top" class="text-sm">
          <ion-tab-button tab="Assignments" @click="this.$router.push('./Assignments')">
            ASSIGNMENT
          </ion-tab-button>
          <ion-tab-button tab="Study Material" @click="this.$router.push('./Study Material')">
            STUDY MATERIAL
          </ion-tab-button>
          <ion-tab-button tab="Syllabus" @click="this.$router.push('./Syllabus')">
            SYLABUS
          </ion-tab-button>
          <ion-tab-button tab="Other Download" @click="this.$router.push('./Other Download')">
            OTHERS
          </ion-tab-button>
        </ion-tab-bar>

      </ion-tabs>
      <ion-list class="mt-5 pb-5">
        <list-component height="40" bodyWidth="100%" v-for="material in materials" :key="material"
          :title="material.title">
          <template v-slot:header-end> {{ material.date }} </template>
          <div class="text-center w-100 text-muted">
            <icon icon="ion:arrow-down-circle" height="40" class="my-2 mx-auto"
